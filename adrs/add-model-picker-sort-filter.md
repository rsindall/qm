# Sort and filter Setup's Add a Model list

In Admin Setup, "Add a model" is a long unsorted dropdown. Finding something like Fable or GPT means scrolling, and you can't type to narrow the list.
